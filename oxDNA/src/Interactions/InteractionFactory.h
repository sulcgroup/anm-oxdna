 ...
 *
 * @verbatim
[interaction_type = DNA|RNA|HS|LJ|GC|patchy|patchyDan|TSP|DNA_relax|DNA_nomesh|Box|HardCylinder|HardSpheroCylinder|DHS|Dirk (Particle-particle interaction of choice. Check the documentation relative to the specific interaction for more details. Defaults to dna.)]
@endverbatim
 */
