...
#ifndef RNACT_INTERACTION_H
#define RNACT_INTERACTION_H
...
class RNACTInteraction: public RNA2Interaction<number> {
...
public:
	...
	RNACTInteraction();    // Constructor
	virtual ~RNACTInteraction() {} // Destructor
